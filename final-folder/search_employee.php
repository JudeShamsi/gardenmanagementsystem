...
<div class="container">
       ...
       // $checkresult = $conn->query($check);
        ...
        <script>
            document.addEventListener('DOMContentLoad', function(){
                document.addSelectQuery('#form').onsubmit = show_alert;

            });

            function show_alert() {
                alert('The Employee Has Successfully Been Deleted');
            }
    ...
    <table class="table">
        ...
        <tr>
            <form id="form" action="" method="post" role = "form-role">
                ...
                <td>
                 ...
                 <td>
                    <input type="submit" name="submitDeleteBtn" class="btn btn-info" id="delete-employee">
                 </td>
            </form>
        </tr>
        <?php  $sr++;}
