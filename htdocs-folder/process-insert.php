<form action="insertgr-query.php" method="post"> 
...
<h1>Add a measured growth rate during specified observation period: </font></label></h1>
<br>
<br>
<br>
...
<input name="start" type="date" placeholder="Enter here">
<br>
<br>
<label>End Date</label>
<input name="end" type="date" placeholder="Enter here">

<br>
<br>
<label>Growth Rate</label>
<input name="growthrate" type="text" placeholder="Enter here">
<br>
<br>
