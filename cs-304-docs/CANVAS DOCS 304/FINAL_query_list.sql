--> all queries are found at the beginning,
--> queries for milestone 5 are found at the end of this file
...
--> deletes the plant from PlantHas as well as GrowthRate for that specific plant 
delete 
from PlantHas 
where P_ID = '$id'
--> user deletes the plant by picking the common name from a drop down menu
