<form action="insertnutrients-query.php" method="post"> 
<style>
body{
...
<form action="insertminerals-query.php" method="post"> 
<center>
...
<form action="insertwater-query.php" method="post"> 
<center>
...
<form action="insertlight-query.php" method="post"> 
<center>
