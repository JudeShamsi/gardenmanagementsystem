<form action="updateplant-query.php" method="post"> 
<style>
body{
...
<br>
<center>
Update the plant description using the common name
</br>
</br>
...
<input name="descrp" type="text" placeholder="Enter new Description">
<br>
<br>
...
<center>
<form action="deleteplant-query.php" method="post"> 
Remove a plant using its common name
</br>
</br>
<label>Plant Common Name</label>
<?php
