...
Task_Type CHAR(20),
FOREIGN KEY (Task_Type) REFERENCES TaskNotes(Task_Type)
);
...
Supplier_email CHAR(100) PRIMARY KEY, 
Suppler_Name CHAR(50),
S_Phone CHAR(20)
);

CREATE TABLE Supplier (
Supplier_ID INT PRIMARY KEY,
Supplier_email CHAR(20) NOT NULL,
FOREIGN KEY (Supplier_email) REFERENCES SupplierInfo(Supplier_email)
);
